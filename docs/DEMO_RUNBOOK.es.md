...
Para el recorrido técnico completo de teoría a código, lee:

- `docs/THEORY_TO_PRACTICE_GUIDE.es.md`

> Versión en inglés: [DEMO_RUNBOOK.md](DEMO_RUNBOOK.md)
...
1. Si falta `python 3.10`, instálalo primero y vuelve a ejecutar `uv venv .venv --python 3.10`.
2. Si la instalación de allRank falla por restricciones de ruedas/compilación, reintenta con un entorno limpio:
...
3. Si el comando de allRank falla por archivos de dataset ausentes, regenera los datos:
